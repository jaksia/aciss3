...
Systém, ktorý je schopný automaticky zvolávať účastníkov sústredenia na program. Z praktických skúseností je potvrdené, že okrem ušetrenia vedúcich zo zvolávania, majú deti tendenciu viac počúvať pri zvolávaní tento systém ako vedúcich.
...
- Automaticky zvláda prechod z letného na zimný čas (alebo naopak)
  - _(zatiaľ nebola príležitosť toto poriadne otestovať, preto by som sa na to nespoliehal)_
...
Dá sa nájsť na adrese [aciss.jaksia.xyz](https://aciss.jaksia.xyz/).
...
AČISS by mal byť kompatibilný s hocičím na čom vie bežať Docker, ale testovaný bol iba na Linuxe.
